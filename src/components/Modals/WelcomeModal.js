...
export const Welcome = () => {
    ...
    return(
    <div className="inset-0 fixed bg-black/45 bg-opacity-100 w-[100%] z-[99999999] min-h-screen h-auto backdrop-blur-sm flex ">
        <div className="w-[100%] flex items-center px- justify-center">
            <div className="h-[190px] ml-auto mr-auto py-2 px-2 w-[90%] bg-black rounded-xl">
            <div>
                <div onClick={() => setWelcome(false)} className="w-16 rounded-xl  font-light flex items-center justify-center h-8 bg-white/55">
            ...
            <div className="mt-5 ml-auto mr-auto flex flex-col items-center justify-center text-center">
                <p className="text-center text-white font-light text-[16px] mb-3">{`👋Hi Welcome Back`} </p>
